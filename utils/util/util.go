...
func GetJson(obj interface{})(jsonString string) {
...
func GetProxyConfigs(user string)(proxyConfigs string){
	//f, err := os.Open("db/"+user+".db")
	f, err := os.Open("/var/frps/"+user+".db")
	if err != nil{
		return ""
	}
